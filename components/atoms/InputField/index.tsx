...
export default function InputField({fieldClassName, className, name, id, placeholder, type, peer, peerValue, value} : Parameters)
{
    return(  
    <div className={className}>
        <Field className={'focus:border-[#FF5C00] focus:ring-2 focus:ring-[#FF5C00] peer drop-shadow-lucifer w-[100%] mx-[0.5rem] px-[0.5rem] min-h-[2rem] h-[100%] text-black text-[1.2rem] font-["Roboto"] bg-white outline-none border-black border-solid border-[1px] rounded-[5px] '+fieldClassName} id={id} name={name} placeholder={placeholder} type={type} value={value}/>
