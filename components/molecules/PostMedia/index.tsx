...
export default function PostMedia({
  ...
  if (isAboveTl) {
    ...
    if (mediaHeight > MAX_TL_HEIGHT) isImageOverflowing = true;
  } else if (isAboveTs) {
    maxHeight = MAX_TS_HEIGHT;

    if (mediaHeight > MAX_TS_HEIGHT) isImageOverflowing = true;
  } else if (isBelowTs) {
    maxHeight = MAX_HEIGHT;

    if (mediaHeight > MAX_HEIGHT) isImageOverflowing = true;
  }

  return (
    <div className=" relative w-[100%] text-left font-normal flex flex-col border-black bg-foregroundL dark:bg-foregroundD border-solid drop-shadow-lg border-2 rounded-[5px] pt-2 min-w-[25vw] my-2">
      ...
      <div className="relative">
        ...
        <div className="flex flex-row">
          <div
            ...
            className={`overflow-y-hidden bg-[rgba(0,0,0,0.3)] px-2 flex-1 relative`}
            style={{
